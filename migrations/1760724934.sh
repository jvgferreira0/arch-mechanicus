...
cp -r $MECHANICUS_PATH/config/mechanicus/* $HOME/.config/mechanicus/

echo "Add packages for updated mechanicus-cmd-screenshot"
mechanicus-pkg-add grim slurp wayfreeze-git

echo "Add nfs support by default to Nautilus"
mechanicus-pkg-add gvfs-nfs
